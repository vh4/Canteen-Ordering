...
<div class="col-md-12">
	<div class="card card-profile">
		<div class="card-header" style="background-image: url(<?php echo e(asset('image/cherry.jpg')); ?>)">
		...
		<div class="card-body">
			<div class="user-profile text-center">
				...
				<div class="desc"><?php echo e(auth()->user()->status); ?></div>
		...
		<div class="card-footer">
			<div class="row user-stats text-center">
				<div class="col">
					<div class="number"><?php echo e(auth()->user()->menu->alamat); ?></div>
					<div class="title">Alamat</div>
				</div>
				<div class="col">
					<div class="number"><?php echo e(auth()->user()->menu->no_pelajar); ?></div>
					<div class="title">No Canteen</div>
				</div>
				<div class="col">
					<div class="number"><?php echo e(auth()->user()->menu->email); ?></div>
...
Highcharts.chart('hacker', {
    ...
    xAxis: {
        categories:<?php echo json_encode($dta); ?>
