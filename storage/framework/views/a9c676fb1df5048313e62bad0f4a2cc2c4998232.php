...
<head>
	...
	*
	...
	<link rel="stylesheet" href="<?php echo e(asset('assets/css/demo.css')); ?>"> </head>

<body class="sb-nav-fixed">
	<nav class="sb-topnav navbar navbar-expand-lg navbar-light " style="background-color:#ffff;"> <img class="navbar-brand" src="<?php echo e(asset('image/13377.png')); ?>" style="left: -1em; position:relative;" width="200px" height="105px;" alt="">
		...
		<ul class="navbar-nav ml-auto ml-md-0"> <a class="nav-link" href="/home/cart">Keranjang
			...
			<!-- Counter - Alerts -->
                                <?php if(Cart::session(auth()->id())->getContent()->count() == 0): ?>
                                <?php elseif(Cart::session(auth()->id())->getContent()->count() > 0): ?>
                                
			<span style="width: 10px; height:20px;top:-1em;left:-1em;position:relative;border-radius:90px" class="badge badge-danger badge-counter"><?php echo e(Cart::session(auth()->id())->getContent()->count()); ?></span>
	...
	<div id="layoutSidenav">
				...
				<div class="sidebar-content">
					<div class="user">
						<div class="avatar-sm float-left mr-2"> <img src="
							<?php if(auth()->user()->status == 'admin'|| auth()->user()->status == 'user'): ?>
					                   	<?php echo e(auth()->user()->menu->fotolain()); ?>
						...
						<div class="info">
							<a data-toggle="collapse" href="/home" aria-expanded="true"> <span>
								...
								<?php if(auth()->user()->status == 'admin'): ?>                                   
										...
										<span class="user-level">Administrator</span> <?php elseif(auth()->user()->status == 'user'): ?> <span class="user-level">User</span> <?php endif; ?> </span>
							</a>
						</div>
					</div>
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="aw">
								<ul class="nav nav-collapse">
									<li>
										<a href="/home/<?php echo e(auth()->user()->id); ?>/edit/profile"> <span class="sub-item">Edite Profile</span> </a>
									</li>
									<li>
										<a href="/home/<?php echo e(auth()->user()->id); ?>/profile"> <span class="sub-item">View Profile</span> </a>
									</li>
								</ul>
							</div>
						</li> <?php if(auth()->user()->status == 'user'): ?>
						<li class="nav-item">
						...
						</li> <?php endif; ?> <?php if(auth()->user()->status == 'admin'): ?>
						<li class="nav-item">
		...
		<div id="layoutSidenav_content">
			<div class="container-fluid">
				...
				<div class="footer-bottom"> <?php echo $__env->yieldContent('content'); ?>
					<div class="container-fluid">
		...
		<script src="<?php echo e(asset('assets/js/setting-demo2.js')); ?>"></script>
		<!-- jQuery Sparkline -->
		<!-- Chart Circle -->
		...
		<script src="<?php echo e(asset('js/public/js/datatables-demo.js')); ?>"></script>
		<script>
