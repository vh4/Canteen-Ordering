...
<table id="cart" class="table table-hover table-condensed">
					...
					<tbody>
						<tr>
							<td data-th="Product">
								<div class="row">
									<div class="col-sm-2 hidden-xs"><img width="100px" height="100px;" src="/image/{{$c->foto_food}}" alt="..." class="img-responsive"/></div>
									<div class="col-sm-10">
							...
							<td data-th="Quantity">
                                <form action="/home/cart/update/qty/{{$c->id}}" method="post">
                                {{csrf_field()}}
                                <div class="btn-group" role="group" aria-label="Basic example">
                                <input name="quantity" type="number" class="form-control text-center" value="{{$c->quantity}}">
							...
							<td class="actions" data-th="">
								<a href="/home/cart"><button class="btn btn-info btn-sm"><i class="fas fa-sync"></i></button></a>
								<a href="/home/cart/delete/{{$c->id}}"><button class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button></a>								
							</td>
                        </tr>
                    </tbody>
                    @endforeach
